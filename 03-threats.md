...
- **Revenge**
- Targeting an entity out of vengance or perceived wrong
...
- **Unskilled Attacker**
- Individual with limited techincal expertise
- Script Kiddies
...
- **Hacktivist**
- Individual who uses hacking tecniques to promote a politial agenda, social change, or ideological beliefs
...
- Managed Service Providers
    - If compromised, can allow access to clients infrasture
- Vendors
    - If compromised, can allow access to clients infrasture
- Suppliers
    - If compromised, can allow access to clients infrasture
